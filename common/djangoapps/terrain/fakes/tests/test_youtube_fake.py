"""
Unit test for fake YouTube implementation.
"""

import unittest
import requests
from terrain.fakes.youtube import FakeYouTubeService


class FakeYouTubeServiceTest(unittest.TestCase):

    def setUp(self):
        self.server = FakeYouTubeService()
        self.url = "http://127.0.0.1:{0}/".format(self.server.port)
        self.server.time_to_response = 0.0
