...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CmeUserProfile.phone_number'
        db.alter_column('cme_registration', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CmeUserProfile.phone_number'
        db.alter_column('cme_registration', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
